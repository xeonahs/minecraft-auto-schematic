Simple commands that paste saved blocks using Schematic in WorldEdit plugin in Minecraft.

1. [Install WorldEdit plugin](https://dev.bukkit.org/projects/worldedit)
